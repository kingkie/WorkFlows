        ...
        public bool IsMatch(DateTime datetime)
        {
            ...
            switch(Kind)
            {
                case CrontabFieldKind.Second: 
                    evalValue = datetime.Second;break;
                case CrontabFieldKind.Minute: 
                    evalValue = datetime.Minute; break;
                case CrontabFieldKind.Hour: 
                    evalValue = datetime.Hour; break;
                case CrontabFieldKind.Day: 
                    evalValue = datetime.Day; break;
                case CrontabFieldKind.Month: 
                    evalValue = datetime.Month; break;
                case CrontabFieldKind.DayOfWeek: 
                    evalValue = datetime.DayOfWeek.ToCronDayOfWeek(); break;
                case CrontabFieldKind.Year:
                    evalValue = datetime.Year;
                    break;
                default:
                    throw new ArgumentOutOfRangeException(nameof(datetime), Kind, null);
            };
