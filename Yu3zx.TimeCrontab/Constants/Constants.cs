...
namespace Yu3zx.TimeCrontab
{
    ...
    internal static class Constants
    {
        ...
        /// Cron 字段种类最大值
        /// </summary>
        internal static readonly Dictionary<CrontabFieldKind, int> MaximumDateTimeValues = new Dictionary<CrontabFieldKind, int>()
        {
        ...
        /// Cron 字段种类最大值
        /// </summary>
        internal static readonly Dictionary<CrontabFieldKind, int> MinimumDateTimeValues = new Dictionary<CrontabFieldKind, int>()
        {
        ...
        /// Cron 不同格式化类型字段数量
        /// </summary>
        internal static readonly Dictionary<CronStringFormat, int> ExpectedFieldCounts = new Dictionary<CronStringFormat, int>()
        {
        ...
        internal static readonly Dictionary<DayOfWeek, int> CronDays = new Dictionary<DayOfWeek, int>()
        {
            { DayOfWeek.Sunday, 0 },
            { DayOfWeek.Monday, 1 },
            { DayOfWeek.Tuesday, 2 },
        ...
        /// </summary>
        internal static readonly Dictionary<string, int> Days = new Dictionary<string, int>()
        {
            { "SUN", 0 },
            { "MON", 1 },
            { "TUE", 2 },
        ...
        /// </summary>
        internal static readonly Dictionary<string, int> Months = new Dictionary<string, int>()
        {
            { "JAN", 1 },
            { "FEB", 2 },
            { "MAR", 3 },
